...
def run(argv):
    ...
    parser = argparse.ArgumentParser(
        description='Run SPLOSH viewer for RAMSES')
...
def main_menu(shared):
    ...
    while True:
        ...
        print('='*window_width)
        header_string = (__code_name +
                         ' - a cheap knockoff of SPLASH for RAMSES')
